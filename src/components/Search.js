    ...
    return (
        <>
            ...
            <div style={{ padding: "20px 40px" }}>
                <Typography variant="h4" style={{ marginBottom: 40 }}>Search Campaigns</Typography>
                <Typography style={{ marginBottom: 30 }}>Fill out at least one field below to search for related campaigns</Typography>
                {/* Form */}
