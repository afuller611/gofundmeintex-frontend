                                ...
                                <CardContent>
                                    ...
                                    <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                                        <Grid container item direction="column" style={{ marginRight: 20 }}>
                                            ...
                                            <Typography style={{ marginBottom: 20, fontWeight: 600 }} variant="body1"><CheckCircle color="secondary" style={{ marginBottom: -6, marginRight: 5 }} />Active for {campaign.days_active} Day(s) </Typography>
                                            <Typography style={{ marginBottom: 20, fontWeight: 600 }} variant="body1"><FontAwesomeIcon style={{ fontSize: 20, color: "#bc1c1c", marginRight: 5 }} icon={faHandHoldingHeart} />{campaign.donators} Donor(s)</Typography>
                                        ...
                                        <Grid container item direction="column">
                                            <Typography style={{ marginBottom: 20, fontWeight: 600 }} variant="body1"><FontAwesomeIcon style={{ fontSize: 20, color: "#00B964", marginRight: 5 }} icon={faBullhorn} />{campaign.social_share_total} Social Media Share(s)</Typography>
                                            <Typography style={{ marginBottom: 20, fontWeight: 600 }} variant="body1"><FontAwesomeIcon style={{ fontSize: 20, color: "#bc1c1c", marginRight: 5 }} icon={faHeart} />{campaign.campaign_hearts} Campaign Heart(s)</Typography>
